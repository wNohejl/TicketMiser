...
public class FollowUpLauncherTests
{
    ...
    public void Floating_a_follow_up_announces_the_change()
    {
        ...
        launcher.Launch(FullDesk(), WindowCatalog.PriceHistory, "EventId", 7, "Home v Away");
    ...
    public void Opening_as_a_window_leaves_the_floating_layer_alone()
    {
        ...
        launcher.Launch(EmptyDesk(), WindowCatalog.PriceHistory, "EventId", 7, "Home v Away");
    ...
    public void Re_launching_the_same_subject_raises_it_and_announces_that()
    {
        ...
        launcher.Launch(desk, WindowCatalog.PriceHistory, "EventId", 7, "Home v Away");
        launcher.Launch(desk, WindowCatalog.AllSources, "EventId", 7, "Home v Away");
        ...
        Assert.Equal(WindowCatalog.PriceHistory, launcher.Open.MaxBy(f => f.Order)!.Key);
    }
    ...
    public void A_different_subject_is_its_own_follow_up()
    {
        ...
        launcher.Launch(desk, WindowCatalog.PriceHistory, "EventId", 7, "Home v Away");
        launcher.Launch(desk, WindowCatalog.PriceHistory, "EventId", 8, "Other v Team");
    ...
    public void Closing_a_whole_kind_announces_only_when_something_went()
    {
        ...
        launcher.Launch(desk, WindowCatalog.LogPurchase, "EventId", 7, "Home v Away");
        launcher.Launch(desk, WindowCatalog.PriceHistory, "EventId", 7, "Home v Away");

        var changes = 0;
        launcher.Changed += () => changes++;

        launcher.CloseAll(WindowCatalog.LogPurchase);
    ...
    public void An_unknown_view_changes_nothing()
    {
        ...
        launcher.Launch(FullDesk(), "not-a-window", "EventId", 7, "Home v Away");
